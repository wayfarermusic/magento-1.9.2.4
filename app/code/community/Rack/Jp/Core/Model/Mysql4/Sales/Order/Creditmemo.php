 ...
 */
class Rack_Jp_Core_Model_Mysql4_Sales_Order_Creditmemo extends Mage_Sales_Model_Mysql4_Order_Creditmemo
{
    /**
     * init virtual grid columns.
     *
     * @return $this|Mage_Sales_Model_Resource_Order_Creditmemo
     */
    protected function _initVirtualGridColumns()
    {
        ...
        $this->addVirtualGridColumn(
                ...
                'CONCAT(IFNULL({{table}}.lastname, ""), " ", IFNULL({{table}}.firstname, ""))'
            )
