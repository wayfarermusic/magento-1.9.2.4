 ...
 */
class Rack_Jp_Core_Model_Sales_Order_Creditmemo_Total_Shipping extends Mage_Sales_Model_Order_Creditmemo_Total_Shipping
{
    /**
     * collect shipping retes for credit memeo
     *
        ...
        if(Mage::helper('jpcore')->canRemoveDecimal($current)) {
            switch($round) {
                case 'ceil':
                    ...
                    $shippingInclTax = ceil($shippingInclTax);
                    break;
                case 'floor':
                    $shipping = floor($shipping);
                    $shippingInclTax = floor($shippingInclTax);
                    break;
            }
        }
        ...
        if(Mage::helper('jpcore')->canRemoveDecimal($base)) {
            switch($round) {
                case 'ceil':
                    ...
                    $baseShippingInclTax = ceil($baseShippingInclTax);
                    break;
                case 'floor':
                    $baseShipping = floor($baseShipping);
                    $baseShippingInclTax = floor($baseShippingInclTax);
                    break;
            }
        }
